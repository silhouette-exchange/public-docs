...
```text
https://api-alpha.silhouette.exchange:8081/swagger/v0/json
```
...
openapi-generator-cli generate \
  -i https://api-alpha.silhouette.exchange:8081/swagger/v0/json \
  -g typescript-axios \
  -o ./generated-client
```
...
docker run -p 8080:8080 \
  -e SWAGGER_JSON_URL=https://api-alpha.silhouette.exchange:8081/swagger/v0/json \
