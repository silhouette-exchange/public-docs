...
|--------|-------------|--------|
| `200` | A single-use login challenge nonce. | [ChallengeResponse](/api/spec/schemas#challengeresponse) |
...
Schema: [LoginRequest](/api/spec/schemas#loginrequest)
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | The minted credential pair, bound to the authenticated account. | [LoginResponse](/api/spec/schemas#loginresponse) |
...
| `401` | SIWE verification failed: bad signature, domain, chain id, or an unknown/consumed nonce. | [ErrorResponse](/api/spec/schemas#errorresponse) |
| `500` | Internal server error. | [ErrorResponse](/api/spec/schemas#errorresponse) |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | The caller's live API keys, newest first. | [ApiKeysResponse](/api/spec/schemas#apikeysresponse) |
