...
Schema: [CreateRfqRequestInput](/docs/api/spec/schemas#createrfqrequestinput)
...
|--------|-------------|--------|
| `202` | Accepted for orchestration. | [CreateRfqRequestResponse](/docs/api/spec/schemas#createrfqrequestresponse) |
...
| `503` | Solvency-locked. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
| `status` | query | No | array of [RfqStatus](/docs/api/spec/schemas#rfqstatus) | Filter by one or more lifecycle statuses. Repeat the key for multiple, e.g. `?status=QUOTED&status=SETTLED`. |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | RFQ requests page. | [RfqsPage](/docs/api/spec/schemas#rfqspage) |
| `400` | Invalid request: the body or query parameters failed validation. The error `code` is `INVALID_REQUEST`; `details.errors` carries the field-level reasons. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Forbidden: the access key is recognised but the request signature does not match the HMAC the gateway recomputes over the received request. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `500` | Internal server error. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | Settled RFQs page. | [RfqsPage](/docs/api/spec/schemas#rfqspage) |
| `400` | Invalid request: the body or query parameters failed validation. The error `code` is `INVALID_REQUEST`; `details.errors` carries the field-level reasons. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Forbidden: the access key is recognised but the request signature does not match the HMAC the gateway recomputes over the received request. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `500` | Internal server error. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | Request detail. | [Rfq](/docs/api/spec/schemas#rfq) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Request belongs to another account. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
Schema: [AcceptRfqQuoteRequest](/docs/api/spec/schemas#acceptrfqquoterequest)
...
| Status | Description | Schema |
|--------|-------------|--------|
| `202` | Quote accepted; settlement proceeds. | [Rfq](/docs/api/spec/schemas#rfq) |
| `400` | Invalid request: the body or query parameters failed validation. The error `code` is `INVALID_REQUEST`; `details.errors` carries the field-level reasons. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Request belongs to another account. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `404` | Request or quote not found. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `409` | Request is not Pending, the quote is no longer acceptable, or the funds are insufficient. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `500` | Internal server error. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | The cancelled RFQ. | [Rfq](/docs/api/spec/schemas#rfq) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Request belongs to another account. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `404` | Not found. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `409` | The RFQ is no longer open and cannot be cancelled. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `500` | Internal server error. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
...
| Status | Description | Schema |
|--------|-------------|--------|
| `200` | Quotes on the request. | [QuotesPage](/docs/api/spec/schemas#quotespage) |
| `400` | Invalid request: the body or query parameters failed validation. The error `code` is `INVALID_REQUEST`; `details.errors` carries the field-level reasons. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `401` | Unauthorized: missing or expired credentials, or an unknown access key. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `403` | Request belongs to another account. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
| `404` | Not found. | [ErrorResponse](/docs/api/spec/schemas#errorresponse) |
