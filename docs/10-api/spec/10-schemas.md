...
| `account` | [EvmAddress](/docs/api/spec/schemas#evmaddress) | Yes |  |
...
| `expiresAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | Credential expiry. |
...
| `createdAtMs` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | When the key was minted. |
| `expiresAtMs` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | When the key expires. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `keys` | array of [ApiKeyView](/docs/api/spec/schemas#apikeyview) | Yes | The caller's live keys, newest first. |
...
| `createdAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `entries` | array of [LedgerView](/docs/api/spec/schemas#ledgerview) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `quoteId` | [QuoteId](/docs/api/spec/schemas#quoteid) | Yes |  |
...
| `details` | null \| [ErrorDetails](/docs/api/spec/schemas#errordetails) | No |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `available` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `locked` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `token` | [TokenSymbol](/docs/api/spec/schemas#tokensymbol) | Yes |  |
| `total` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `amount` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `createdAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
| `depositId` | [DepositId](/docs/api/spec/schemas#depositid) | Yes |  |
| `status` | [DepositStatus](/docs/api/spec/schemas#depositstatus) | Yes |  |
| `token` | [TokenSymbol](/docs/api/spec/schemas#tokensymbol) | Yes |  |
| `txHash` | [TxHash](/docs/api/spec/schemas#txhash) | Yes |  |
| `updatedAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [Deposit](/docs/api/spec/schemas#deposit) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `errors` | array of [ValidationErrorDetail](/docs/api/spec/schemas#validationerrordetail) | No | Field-level validation errors; present for `INVALID_REQUEST`. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `error` | [ApiError](/docs/api/spec/schemas#apierror) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `balances` | array of [Balance](/docs/api/spec/schemas#balance) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `instruments` | array of [Instrument](/docs/api/spec/schemas#instrument) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `base` | [TokenSymbol](/docs/api/spec/schemas#tokensymbol) | Yes | Canonical base-token symbol. |
| `type` | [InstrumentType](/docs/api/spec/schemas#instrumenttype) | Yes |  |
| `instrumentId` | [InstrumentId](/docs/api/spec/schemas#instrumentid) | Yes | Canonical instrument identifier (`BASE-QUOTE-TYPE`, uppercase). |
| `quote` | [TokenSymbol](/docs/api/spec/schemas#tokensymbol) | Yes | Canonical quote-token symbol. |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [OpenRfq](/docs/api/spec/schemas#openrfq) | Yes |  |
| `nextCursor` | string \| null | No |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `rfqId` | [RfqId](/docs/api/spec/schemas#rfqid) | Yes |  |
| `quoteId` | [QuoteId](/docs/api/spec/schemas#quoteid) | Yes |  |
| `instrumentId` | [InstrumentId](/docs/api/spec/schemas#instrumentid) | Yes |  |
| `side` | [Side](/docs/api/spec/schemas#side) | Yes |  |
| `status` | [QuoteStatus](/docs/api/spec/schemas#quotestatus) | Yes |  |
| `makerPays` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `makerReceives` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `expiryMs` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | The quote's expiry; on a win the engine uses it, converted to seconds, as the Permit2 deadline. |
| `receivedAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
| `permitSignature` | string \| null | No | Engine-signed Permit2 signature (0x-hex), to relay on-chain. Present only when selected. |
| `spender` | null \| [EvmAddress](/docs/api/spec/schemas#evmaddress) | No | Permit2 spender (the maker's wrapper). Present only when selected. |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [MakerQuote](/docs/api/spec/schemas#makerquote) | Yes |  |
| `nextCursor` | string \| null | No |  |
...
| `makerPays` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `makerReceives` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `expiryMs` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | The quote's expiry, beyond which it can't be accepted. |
| `receivedAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [Quote](/docs/api/spec/schemas#quote) | Yes |  |
| `nextCursor` | string \| null | No |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `baseQty` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `createdAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
| `expiresAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | Auction deadline; the maker must quote before this. |
| `instrumentId` | [InstrumentId](/docs/api/spec/schemas#instrumentid) | Yes |  |
| `id` | [RfqId](/docs/api/spec/schemas#rfqid) | Yes |  |
| `side` | [Side](/docs/api/spec/schemas#side) | Yes |  |
...
| `settlement` | [XchangeSettlement](/docs/api/spec/schemas#xchangesettlement) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `swapMessage` | [SwapMessage](/docs/api/spec/schemas#swapmessage) | Yes |  |
...
| `incomingTransfer` | [SwapTransfer](/docs/api/spec/schemas#swaptransfer) | Yes |  |
| `outgoingTransfer` | [SwapTransfer](/docs/api/spec/schemas#swaptransfer) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `token` | [EvmAddress](/docs/api/spec/schemas#evmaddress) | Yes |  |
| `from` | [EvmAddress](/docs/api/spec/schemas#evmaddress) | Yes |  |
| `to` | [EvmAddress](/docs/api/spec/schemas#evmaddress) | Yes |  |
...
| `makerPays` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `makerReceives` | [QuoteLeg](/docs/api/spec/schemas#quoteleg) | Yes |  |
| `expiryMs` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | The quote's expiry; the engine converts it to seconds for the on-chain Permit2 deadline. |
| `xchange` | null \| [XchangeBundle](/docs/api/spec/schemas#xchangebundle) | No | xchange-mode settlement bundle; omit for inventory-mode makers. |
...
| `baseQty` | [PositiveDecimalString](/docs/api/spec/schemas#positivedecimalstring) | Yes |  |
| `instrumentId` | [InstrumentId](/docs/api/spec/schemas#instrumentid) | Yes | Canonical instrument identifier (e.g. `XTSLA-USDC-SPOT`). |
| `quoteLimit` | [PositiveDecimalString](/docs/api/spec/schemas#positivedecimalstring) | Yes | BUY = max we'll pay; SELL = min we'll accept. |
| `side` | [Side](/docs/api/spec/schemas#side) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `status` | [RfqStatus](/docs/api/spec/schemas#rfqstatus) | Yes |  |
| `rfqId` | [RfqId](/docs/api/spec/schemas#rfqid) | Yes |  |
| `expiresAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | The server-selected auction deadline, derived from the requested (clamped) `windowSecs`. Quotes are gathered until this time; with `autoAccept` the engine selects the winner here. Returned so the client knows the effective expiry without re-deriving it. |
...
| `baseQty` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `createdAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
| `expiresAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes | Auction deadline. |
| `failureReason` | string \| null | No |  |
| `instrumentId` | [InstrumentId](/docs/api/spec/schemas#instrumentid) | Yes |  |
| `quoteLimit` | [DecimalString](/docs/api/spec/schemas#decimalstring) | Yes |  |
| `quotedAt` | null \| [UnixMillis](/docs/api/spec/schemas#unixmillis) | No |  |
| `settledAt` | null \| [UnixMillis](/docs/api/spec/schemas#unixmillis) | No |  |
| `side` | [Side](/docs/api/spec/schemas#side) | Yes |  |
| `status` | [RfqStatus](/docs/api/spec/schemas#rfqstatus) | Yes |  |
| `id` | [RfqId](/docs/api/spec/schemas#rfqid) | Yes |  |
| `txHash` | null \| [TxHash](/docs/api/spec/schemas#txhash) | No |  |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [Rfq](/docs/api/spec/schemas#rfq) | Yes |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `status` | [WithdrawalStatus](/docs/api/spec/schemas#withdrawalstatus) | Yes |  |
| `withdrawalId` | [WithdrawalId](/docs/api/spec/schemas#withdrawalid) | Yes |  |
...
| `failureReason` | string \| null | No |  |
| `status` | [WithdrawalStatus](/docs/api/spec/schemas#withdrawalstatus) | Yes |  |
| `toAddress` | [EvmAddress](/docs/api/spec/schemas#evmaddress) | Yes |  |
| `token` | [TokenSymbol](/docs/api/spec/schemas#tokensymbol) | Yes |  |
| `txHash` | null \| [TxHash](/docs/api/spec/schemas#txhash) | No |  |
| `updatedAt` | [UnixMillis](/docs/api/spec/schemas#unixmillis) | Yes |  |
| `withdrawalId` | [WithdrawalId](/docs/api/spec/schemas#withdrawalid) | Yes |  |
...
|-------|------|----------|-------------|
| `hasMore` | boolean | Yes |  |
| `items` | array of [Withdrawal](/docs/api/spec/schemas#withdrawal) | Yes |  |
| `nextCursor` | string \| null | No |  |
